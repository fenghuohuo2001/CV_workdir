...
def detection_lane_windows(img):
    ...
    try:
        # 用二次曲线拟合
        left_fitx = left_fit[0]*ploty**2 + left_fit[1]*ploty + left_fit[2] + 220
        right_fitx = right_fit[0]*ploty**2 + right_fit[1]*ploty + right_fit[2] + 220
    except TypeError:
        print('The function failed to fit a line!')
        left_fitx = 1 * ploty ** 2 + 1 * ploty + 220
        right_fitx = 1 * ploty ** 2 + 1 * ploty + 220

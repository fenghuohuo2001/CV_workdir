...
def show_line(lines, img, left_mid_point, right_mid_point, slope_left_input, slope_right_input, sigma=200):
    ...
    return img, left_slopes, right_slopes, left_mid_point_xs, right_mid_point_xs, left_slope_compared, right_slope_compared
...
def detection_lane_hough(img, left_mid_point, right_mid_point, slope_left_input, slope_right_input):
    ...
    # 绘制检测结果
    img, left_slopes, right_slopes, left_mid_point_xs, right_mid_point_xs, slope_lefts, slope_rights = show_line(lines, img, left_mid_point, right_mid_point, slope_left_input, slope_right_input)

    return img, img_edge, img_cut, left_mid_point_xs, right_mid_point_xs, slope_lefts, slope_rights
...
while True:
    ...
    if ret:
        ...
        frame, canny, cut, left_mid_point_xs, right_mid_point_xs, slope_lefts, slope_rights = detection_lane_hough(frame, left_mid_point, right_mid_point, slope_left_input, slope_right_input)

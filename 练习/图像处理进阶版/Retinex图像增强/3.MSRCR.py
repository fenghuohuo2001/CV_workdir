...
def main():
    ...
    image1 = cv2.imread("paper_data/3842.jpg")
    image = 255-image1
    cv2.imwrite("paper_data/oppo.jpg", image)
    ...
    cv2.imwrite("paper_data/paper_total.jpg", np.hstack([image, ssr, msr, msrcr]))
    cv2.imwrite("paper_data/paper.jpg", msrcr)
    cv2.waitKey(0)

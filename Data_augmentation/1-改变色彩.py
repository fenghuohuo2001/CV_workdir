...
def main():
    ...
    # masaic_process(image)

    gaussian_process(image, 5, 19, True)

    gaussian_noise_process(image, 0, 100, True)

    brightness_trans_process(image, 50, "down", True)

    brightness_trans_process(image, 50, "up", True)

...
def contour_detection(img_gas):
    # canny
    img_canny = cv2.Canny(img_gas, 0, 50)
    # cv_show(1000, img_canny=img_canny)
...
if __name__=="__main__":
    img_segmentation, img_resize = Segmentation()
    main(img_segmentation, img_resize)